...
def get_video_metadata(video_id, max_retries=3):
    ...
    if oauth_token or YOUTUBE_API_KEY:
        ...
        for attempt in range(max_retries):
            try:
                ...
                return {
                    ...
                    "author": snippet.get("channelTitle", "AI Automators"),
        ...
        print("  Warning: No YouTube OAuth credentials or API key, trying oEmbed fallback")
    ...
    if oe and oe.get("title"):
        ...
        return {
            ...
            "publish_date": "",
            "description": "",
            "author": oe.get("author") or "AI Automators",
            "keywords": [],
        }
...
author: "{metadata.get("author", "AI Automators")}"
{desc_yaml}
