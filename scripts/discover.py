#!/usr/bin/env python3
"""
Discover new AI Automators videos via YouTube Data API v3.
...
CHANNEL_ID = "UCwvXnrOCRlhokHlJwohf2OA"
    ...
    for attempt in range(1, retries + 1):
        try:
            ...
            if attempt < retries and (e.code in (429,) or 500 <= e.code < 600):
                ...
                print(
                    f"  Attempt {attempt} HTTP {e.code}: {e}. Retrying in {wait}s..."
                )
                time.sleep(wait)
                continue
            break
...
def main():
    print("=== AI Automators Video Discovery (YouTube Data API v3) ===")
